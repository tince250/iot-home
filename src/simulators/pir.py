...
def run_pir_simulator(delay, motion_detected_callback, no_motion_detected_callback, stop_event, publish_event, settings, motion_detected_event, threshold=0.6):
    previous_move = False
