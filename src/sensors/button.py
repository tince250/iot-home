...
import time
from components.button import button_callback
...
class Button(object):
    ...
    def detect_button_press(self, publish_event, settings):
        ...
        GPIO.add_event_detect(self.pin, GPIO.FALLING, callback = lambda x: button_callback(publish_event, settings), bouncetime = 100)
